...
public class UtilHelper {
	...
	public Slot getFocusedSlot(AbstractContainerScreen<?> container) {
		Field f = this.findField(AbstractContainerScreen.class, "focusedSlot", "field_2787");
		f.setAccessible(true);
		try {
    ...
    public int getContainerWidth(AbstractContainerScreen<?> screen) {
    	Field f = findField(AbstractContainerScreen.class, "containerWidth", "field_2792");
    	f.setAccessible(true);
    	try {
    ...
    public int getContainerHeight(AbstractContainerScreen<?> screen) {
    	Field f = findField(AbstractContainerScreen.class, "containerHeight", "field_2779");
    	f.setAccessible(true);
    	try {
			return f.getInt(screen);
		} catch (IllegalArgumentException | IllegalAccessException e) {
