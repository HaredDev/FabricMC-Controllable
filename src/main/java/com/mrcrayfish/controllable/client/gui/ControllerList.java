 ...
 * Author: MrCrayfish
 */
public class ControllerList extends AlwaysSelectedEntryListWidget<ControllerEntry>
{
    private SDL2ControllerManager manager;

    public ControllerList(SDL2ControllerManager manager, MinecraftClient mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn)
    {
