...
{
    public static final Identifier TEXTURE = new Identifier(Reference.MOD_ID, "textures/gui/controller.png");
    ...
    {
        super(new TranslatableText("controllable.gui.title.layout"));
    ...
    protected void init()
    {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 100, this.height - 32, 200, 20, I18n.translate("gui.done"), (button) -> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.font, this.title.getString(), this.width / 2, 20, 0xFFFFFF);
