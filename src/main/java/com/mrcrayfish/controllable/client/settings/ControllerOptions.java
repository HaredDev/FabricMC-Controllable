...
public class ControllerOptions
{
    ...
    public static final ControllableEnumOption<CursorType> CURSOR_TYPE = new ControllableEnumOption<>("controllable.options.cursorType", CursorType.class, gameSettings -> {
        ...
        return I18n.translate("controllable.cursor." + cursorType.asString());
    });
    ...
    public static final ControllableEnumOption<ControllerType> CONTROLLER_TYPE = new ControllableEnumOption<>("controllable.options.controllerType", ControllerType.class, gameSettings -> {
        ...
        return I18n.translate("controllable.controller." + controllerType.asString());
    });
    ...
    public static final DoubleOption DEAD_ZONE = new ControllableSliderPercentageOption("controllable.options.deadZone", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return I18n.translate("controllable.options.deadZone.format", FORMAT.format(deadZone));
    });

    public static final DoubleOption ROTATION_SPEED = new ControllableSliderPercentageOption("controllable.options.rotationSpeed", 1.0, 50.0, 1.0F, gameSettings -> {
        ...
        return I18n.translate("controllable.options.rotationSpeed.format", FORMAT.format(rotationSpeed));
    });

    public static final DoubleOption MOUSE_SPEED = new ControllableSliderPercentageOption("controllable.options.mouseSpeed", 1.0, 50.0, 1.0F, gameSettings -> {
        ...
        return I18n.translate("controllable.options.mouseSpeed.format", FORMAT.format(mouseSpeed));
    });
    ...
    public void saveOptions()
    {
        try(PrintWriter writer = new PrintWriter(new OutputStreamWriter(new FileOutputStream(this.optionsFile), StandardCharsets.UTF_8)))
        {
            ...
            writer.println("cursorType:" + this.cursorType.asString());
            writer.println("controllerType:" + this.controllerType.asString());
